...
namespace ATQ1MR_HFT_2021221.Data
{
    public class PcPartsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var mboard3 = new Motherboard() { Id = 2, BrandId = gigabyte.Id, Chipset = "B450", Price = 32000, Socket = "AM4", Type = "AORUS PRO" };
            ...
            var cpu3 = new Processor() { Id = 2, BrandId = amd.Id, Name = "Ryzen 5 5600X", Socket = "AM4", Cores = 6, Threads = 12, BaseClock = 3.7, BoostClock = 4.6, Price = 122000 };
            var cpu4 = new Processor() { Id = 2, BrandId = intel.Id, Name = "Core i5-9400F", Socket = "LGA-1151(300)", Cores = 6, Threads = 6, BaseClock = 2.9, BoostClock = 4.1, Price = 57000 };
